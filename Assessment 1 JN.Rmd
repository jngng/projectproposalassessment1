...
Here you need to report on your data. Specifically, the size of our data sets, such as the number of observations, variables and variable types. You will need to include the following:
