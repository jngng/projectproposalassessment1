...
**Data Set 1** contains 25,516 observations and is 205,432 in bytes size. It overall has 4 variables: 2 of them are String variables ('Entity' and 'Code') and 2 are Integer variables ('Year' and 'Number of Internet Users').         
...
# get total observations of data set 1
...
cat("The number of observations in Data Set 1 is:", totalDataSet1Size )
...
**Data Set 2** contains 26,132 observations and is 210,248 in bytes size. It overall has 4 variables: 2 of them are String variables ('Entity' and 'Code') and 2 are Integer variables ('Year' and 'Individuals using the Internet (% of population)').    
...
# get total observations of data set 2
...
cat("The number of observations in Data Set 2 is:", totalDataSet2Size )
...
**Data Set 3** contains 15,576 observations and is 135,568 in bytes size. It overall has 4 variables: 2 of them are String variables ('Entity' and 'Code') and 2 are Integer variables ('Year' and 'Fixed Broadband Subscriptions').    
...
# get total observations of data set 3
...
cat("The number of observations in Data Set 3 is:", totalDataSet3Size )
...
It is interesting to note that the Minimum values decreased between 2000 and 2005 as well as between 2015 and 2020. Similarly, the 25th percentile (1st Quartile) values from 2000 to 2005 also experienced a downward trend. This decline can be attributed to the improvements in Internet infrastructures, such as advancements like broadband and WIFI connections. These new structures allow for faster access and connection to the Internet, which may have resulting in the decrease of landline Internet subscriptions in these time periods. 
...
<i>Figure 8</i> showcases the global fixed broadband subscription in the year 2005, highlighting the number of subscriptions by country. Notably, the United States claims the top position with the highest number of fixed broadband subscriptions, reaching 51.16 million subscriptions during that year. China also holds a significant position in the ranking, with 37.35 million subscriptions.
...
Hannah Ritchie, Edouard Mathieu, Max Roser and Esteban Ortiz-Ospina (2023) - "Internet". Published online at OurWorldInData.org. Retrieved from: 'https://ourworldindata.org/internet'
